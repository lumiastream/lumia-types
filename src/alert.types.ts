...
export const LumiaAlertConfigs: Record<
    LumiaAlertValues | string,
    {
        ...
        quickActions?: Array<{ label: string; dynamic: LumiaDynamicCondition; extraSettings?: Record<string, string | number> }>;
...
> = {
    ...
    [LumiaAlertValues.TWITCH_SUBSCRIBER]: {
        ...
        quickActions: [
            { label: 'Tier 2 Sub', dynamic: { value: 2 }, extraSettings: { username: 'random', tier: 2, subPlan: 2000 } },
            { label: 'Gift 5 Subs', dynamic: { value: 100, isGift: true }, extraSettings: { username: 'randomusername', tier: 1, subPlan: 1000, giftAmount: 5, totalGifts: 5, message: 'random' } },
            {
                label: 'Resubscribed for 3 months',
                dynamic: { value: 1, subMonths: 3 },
                extraSettings: { username: 'randomusername', tier: 1, subMonths: 3, streakMonths: 3, subPlan: 1000, message: 'random' },
            },
        ],
    ...
    [LumiaAlertValues.TWITCH_BITS]: {
        ...
        quickActions: [
            { label: '100 bits', dynamic: { value: 100 }, extraSettings: { username: 'randomusername', amount: 100 } },
            { label: '500 bits', dynamic: { value: 500 }, extraSettings: { username: 'randomusername', amount: 500 } },
            { label: '1000 bits', dynamic: { value: 1000 }, extraSettings: { username: 'randomusername', amount: 1000 } },
        ],
        LumiaVariationConditions: [
            { type: LumiaVariationConditions.RANDOM },
            {
    ...
    [LumiaAlertValues.TWITCH_HOST]: {
        ...
        quickActions: [
            { label: '10 viewers', dynamic: { value: 10 }, extraSettings: { username: 'randomusername', viewers: 10 } },
            { label: '50 viewers', dynamic: { value: 50 }, extraSettings: { username: 'randomusername', viewers: 50 } },
            { label: '100 viewers', dynamic: { value: 100 }, extraSettings: { username: 'randomusername', viewers: 100 } },
        ],
        LumiaVariationConditions: [
            { type: LumiaVariationConditions.RANDOM },
            {
    ...
    [LumiaAlertValues.TWITCH_GOAL_ENDED]: {
        ...
        acceptedVariables: ['goal_type', 'goal_id', 'goal_description', 'goal_aomunt', 'goal_target_amount', 'goal_achieved', 'target_achieved', 'goal_status'],
        LumiaVariationConditions: [
            { type: LumiaVariationConditions.RANDOM },
        ...
        quickActions: [
            {
                ...
                extraSettings: { username: 'randomusername', amount: 100, currency: LumiaVariationCurrency.USD, message: 'random' },
            },
        ],
        LumiaVariationConditions: [
            { type: LumiaVariationConditions.RANDOM },
