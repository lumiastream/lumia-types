...
export const LumiaAlertConfigs: {
    [key: string]: Record<
        LumiaAlertValues | string,
        {
            ...
            LumiavariationConditions: Array<{ type: LumiaVariationConditions; selections?: Array<{ label: string; message?: string; value: string | number }> }>;
        }
    >;
} = {
    twitch: {
        ...
        [LumiaAlertValues.TWITCH_SUBSCRIBER]: {
            ...
            acceptedVariables: ['username', 'tier', 'giftAmount', 'totalGifts', 'subMonths', 'message', 'subPlan', 'subPlanName'],
