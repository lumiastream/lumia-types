...
export const AllVariables = {
	...
	facebook: {
		...
		alerts: {
			...
			subscriptionGift: ['username', 'recipient', 'gifter', 'giftAmount', 'message'],
			share: ['username'],
		},
	},
	fourthwall: {
	...
	kick: {
		...
		alerts: {
			...
			follower: ['username'],
			subscriber: ['username'],
			subscriptionGift: ['username', 'recipient', 'gifter', 'value', 'giftAmount', 'totalGifts'],
	...
	trovo: {
		...
		alerts: {
			...
			subscriptionGift: ['username', 'displayname', 'recipient', 'gifter', 'value', 'subPlan', 'message', 'giftAmount', 'totalGifts', 'subMonths', 'sub_tier', 'sub_level', 'roles', 'medals'],
